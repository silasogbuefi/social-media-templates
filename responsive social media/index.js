...
const messageNames = document.querySelectorAll('.message h5')
...
// remove active clast from all menu items
...
const searchMessage = () => {
    ...
    message.forEach((msg) => {
        let name = messages.querySelectorAll('h5');

        name.forEach(user => {
            msg.textContent.toLowerCase()
            if(user.innerText.includes(val)) {
...
/*********FONT SIZES */
// remove active from span or font size selector
